...
class Order(models.Model):
    o_user = models.ForeignKey("user.User", related_name="order_user", on_delete=models.CASCADE, db_column="user_id")
...
class Order_detail(models.Model):
    ...
    od_pd = models.ForeignKey("main.Hobby", related_name="order_hobby", on_delete=models.CASCADE, db_column="od_hobby")
